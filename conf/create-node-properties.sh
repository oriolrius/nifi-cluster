#!/bin/bash
# Generate node-specific nifi.properties files

for i in 1 2 3; do
  cat > "/home/oriol/miimetiq3/nifi-cluster/conf/nifi-${i}/nifi.properties" << EOF
# Licensed to the Apache Software Foundation (ASF) under one or more
# contributor license agreements.  See the NOTICE file distributed with
# this work for additional information regarding copyright ownership.

# NiFi Cluster Node ${i} Configuration
# Generated: $(date)
...
nifi.cluster.node.address=nifi-${i}
...
chmod +x "/home/oriol/miimetiq3/nifi-cluster/conf/create-node-properties.sh"
echo "Generated nifi.properties for all nodes"
