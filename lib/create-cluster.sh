...
echo -e "  View logs:         ${YELLOW}docker compose -f docker-compose-${CLUSTER_NAME}.yml logs -f ${CLUSTER_NAME}-nifi-1${NC}"
echo -e "  Check status:      ${YELLOW}docker compose -f docker-compose-${CLUSTER_NAME}.yml ps${NC}"
echo -e "  Stop cluster:      ${YELLOW}docker compose -f docker-compose-${CLUSTER_NAME}.yml down${NC}"
echo -e "  Restart cluster:   ${YELLOW}docker compose -f docker-compose-${CLUSTER_NAME}.yml restart${NC}"
echo ""
echo -e "${GREEN}╔════════════════════════════════════════════════════════════════╗${NC}"
