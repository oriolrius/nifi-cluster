...
Validations Performed:
  ...
  4. Node addresses & remote input hosts
  5. ZooKeeper configuration
  6. Docker Compose file & service count
  7. Port conflicts & availability
...
echo ""
echo -e "${CYAN}════════════════════════════════════════════════════════════════${NC}"
echo -e "${CYAN} 5. ZooKeeper Configuration Validation${NC}"
echo -e "${CYAN}════════════════════════════════════════════════════════════════${NC}"
echo ""
...
echo ""
echo -e "${CYAN}════════════════════════════════════════════════════════════════${NC}"
echo -e "${CYAN} 6. Docker Compose Validation${NC}"
echo -e "${CYAN}════════════════════════════════════════════════════════════════${NC}"
echo ""
...
# Check service count
print_check "SVC" "Checking service count in compose file"
if [ -f "$COMPOSE_FILE" ]; then
...
echo ""
echo -e "${CYAN}════════════════════════════════════════════════════════════════${NC}"
echo -e "${CYAN} 7. Port Conflict Check${NC}"
echo -e "${CYAN}════════════════════════════════════════════════════════════════${NC}"
echo ""
